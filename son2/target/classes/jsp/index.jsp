        ...
        <c:if test="${requestScope.list!=null}">
            ...
            <div class="row">
                <div class="container">
                    <div class="jumbotron">
                        <h3>${article.titel}</h3>
                        <%--<span class="summary">${article.content}</span><br/><br/>--%>
                        <p><a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath}/boke/findById?id=${article.id}&qian=2" role="button">阅读全文</a></p>
                    </div>
                </div>
            </div>
            </c:forEach>
